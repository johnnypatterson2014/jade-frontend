                ...
                <>
                        <MathJax>
                                        ...
                                        <Tabs>
                                                ...
                                                <Tab2 title="Common Derivatives" isChecked={true}>
                                                        ...
                                                        <div className='flex flex-row gap-[10px] mb-[20px]'>
                                                                <div>
                                                                        <Button>
                                                                                <a onClick={() => viewModal('1')}>detailed explanation</a>
                                                                        </Button>
                                                                </div>
                                                        ...
                                                        <h1 className='no-top-margin'>Motivation</h1>
                                                        <p>
                                                ...
                                                <Tab title="Derivative Rules" isChecked={false}>
                                                        <div className='grid grid-cols-3 gap-[10px] items-start w-full'>
                                                                ...
                                                                <div className='col-span-2 w-[700px] mt-[50px]'>
                                                                ...
                                                                <div className='col-span-2 w-[700px] mt-[40px]'>
                                                                        <img src='/screenshots/024.png' width='700px' />

                                                                </div>

                                                                <div className='col-start-1 p-[0px]'>
                                                                ...
                                                                <div className='col-span-2 w-[700px] mt-[0px]'>

                                                                        <div className='mt-[10px] bg-zinc-600'>
                                                ...
                                                <Tab title="Derivatives in python" isChecked={false}>
                                                ...
                                                <Tab title="Labs & Assignments" isChecked={false}>
                                ...
                                <Modal id="modal-1">
                                        ...
                                        <div className="page-notes-wrapper justify-items-center">
                                                <div className="page-notes w-4/5">
