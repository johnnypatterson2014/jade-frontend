                ...
                <>
                        <div className='m-[10px]'>
                                ...
                                <div className='jade-h1'>
                                        python for java developers - intermediate
                                </div>

                                <div className="tabs tabs-lift">
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="classes" defaultChecked />
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="modules" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="functional programming" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="file handling" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
