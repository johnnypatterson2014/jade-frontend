                ...
                <>
                        <div className='m-[10px]'>
                                ...
                                <div className='jade-h1'>
                                        python for java developers - fundamentals
                                </div>

                                <div className="tabs tabs-lift">
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="fundamentals" defaultChecked />
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="functions" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="containers" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="strings & regex" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="exceptions" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
