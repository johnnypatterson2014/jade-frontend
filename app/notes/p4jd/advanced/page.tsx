                ...
                <>
                        <div className='m-[10px]'>
                                ...
                                <div className='jade-h1'>
                                        python for java developers - advanced
                                </div>

                                <div className="tabs tabs-lift">
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="numpy" defaultChecked />
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="pandas" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
                                        ...
                                        <input type="radio" name="my_tabs_1" className="tab" aria-label="visualization prediction & analysis" />
                                        <div className="tab-content bg-base-100 border-base-300 p-6">
                                                <div className='jade-code'>
