    ...
    <>
      <div className='m-[10px]'>
        ...
        <div className="tabs tabs-lift">
          <input type="radio" name="my_tabs_1" className="tab" aria-label="chapter 1" defaultChecked />
          ...
          <input type="radio" name="my_tabs_1" className="tab" aria-label="chapter 2" />
          <div className="tab-content bg-base-100 border-base-300 p-6">
            <div className='jade-code'>
          ...
          <input type="radio" name="my_tabs_1" className="tab" aria-label="chapter 4" />
          <div className="tab-content bg-base-100 border-base-300 p-6">
            <div className='jade-code'>
